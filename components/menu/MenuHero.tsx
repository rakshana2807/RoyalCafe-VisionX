...
export default function MenuHero({
  ...
  return (
    <section className="pt-32 pb-8 bg-background flex flex-col items-center text-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col items-center">

        {/* Title */}
        <h1 className="text-4xl sm:text-5xl md:text-[52px] leading-tight font-bold font-serif text-[#5A2E0C] mb-4 animate-fade-in">
        ...
        <div className="w-full max-w-4xl flex flex-col sm:flex-row gap-3 items-center mb-8 animate-fade-in delay-200">
        ...
        {/* High-Level Main Filters Row */}
        <div className="w-full max-w-5xl mb-6 animate-fade-in delay-250">
          <div className="flex flex-wrap items-center justify-center gap-2">
            <span className="text-[10px] font-bold text-foreground/45 uppercase tracking-wider mr-2 flex items-center gap-1">
              ...
              return (
                <button
                  ...
                  className={`px-3.5 py-1.5 rounded-full text-xs font-bold transition-all duration-200 cursor-pointer ${
                    isActive
                      ? "bg-[#EA5A0C] text-white shadow-sm"
                      : "bg-[#FAF6F0] text-primary/80 hover:bg-[#EAE0D5] border border-primary/5"
                  }`}
                >
                  {filter}
                </button>
        ...
        {/* 26 Category Selector Tabs */}
        <div className="w-full max-w-6xl animate-fade-in delay-300 pt-2 border-t border-primary/5">
          <CategoryTabs
