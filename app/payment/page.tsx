...
function PaymentContent() {
  ...
  const amountParam = parseFloat(searchParams.get("amount") || "368");

  const subtotal = amountParam;
          ...
          <div className="lg:col-span-5 bg-white p-6 sm:p-8 rounded-[2.5rem] card-shadow border border-primary/5 space-y-6">
            ...
            <div className="pt-4 border-t border-primary/10 space-y-2 text-xs">
              <div className="flex justify-between text-foreground/70">
                <span>Reservation Base Fee</span>
                <span className="font-semibold text-primary">₹{subtotal.toFixed(0)}</span>
              </div>
              <div className="flex justify-between text-foreground/70">
                <span>GST (5%)</span>
                <span className="font-semibold text-primary">₹{tax.toFixed(0)}</span>
              </div>
